...
CREATE TABLE COLABORADORES_CARGOS (
    COD_COLAB VARCHAR(10) NOT NULL,
    COD_SALARIO_CAR VARCHAR(10) NOT NULL,
    PRIMARY KEY (COD_COLAB, COD_SALARIO_CAR)
);
...
CREATE TABLE SALARIOSCARGO (
    ...
    PRIMARY KEY (COD_SALARIO_CAR)
);

CREATE TABLE DEPENDENTES (
    COD_COLAB VARCHAR(10) NOT NULL,
    COD_DEPENDENTE VARCHAR(10) NOT NULL,
...
CREATE TABLE FORNECEDOR_LOJA(
    COD_FOR VARCHAR(10) NOT NULL,
    COD_LOJA VARCHAR(10) NOT NULL,
    PRIMARY KEY (COD_FOR,COD_LOJA)
);

CREATE TABLE FORNECEDOR_EDITORA(
    COD_FOR VARCHAR(10) NOT NULL,
    COD_EDITORA VARCHAR(10) NOT NULL,
    PRIMARY KEY (COD_FOR, COD_EDITORA)
);
